...
-- =============================================
-- 神奈川県の追加斎場 第2弾（45件）
-- いい葬儀・かながわ葬儀ネット等の実データに基づく拡充
-- =============================================

INSERT INTO venues (name, slug, venue_type, description, address, prefecture_slug, city_slug, latitude, longitude, nearest_station, station_walk_minutes, capacity_max, hall_count, has_crematorium, parking_count, facilities, price_plans, features, operator_name, rating_avg, review_count) VALUES

-- 1. 大和斎場（大和市・海老名市・綾瀬市・座間市共同運営の公営火葬場）
(
  '大和斎場',
  'yamato-saijo',
  'public_crematorium',
  '大和市・海老名市・綾瀬市・座間市の4市が共同運営する公営斎場。火葬炉8基（大型4・標準4）、待合室10室、式場4室（30席・80席・120席）を備えた大規模施設。安置室での宿泊も可能で、4市民は火葬料が減額されます。',
  '神奈川県大和市西鶴間8-10-8',
  'kanagawa', 'yamato',
  35.4730, 139.4580,
  '小田急江ノ島線 南林間駅',
  15,
  120, 4, true, 170,
  '{"霊安室": true, "エレベーター": true, "バリアフリー": true, "駐車場": true, "宿泊施設": true, "安置室": true, "売店": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 88000}, {"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 238000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 378000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 578000}]',
  ARRAY['火葬場併設', '公営斎場', '4市共同運営', '大型駐車場', '宿泊可能', '複数式場', 'バリアフリー'],
  '大和斎場管理組合',
  4.2, 92
),
...
(
  ...
  'seikosha-saijo',
  'private_crematorium',
  '逗子市にある神奈川県で2か所のみの民営火葬場の一つ。火葬炉4基と待合室5室を備え、ペット火葬にも対応。逗子市・葉山町の住民に広く利用されており、海沿いの穏やかな環境が特長です。',
  '神奈川県逗子市小坪7-1216',
  'kanagawa', 'zushi',
  35.2940, 139.5580,
  'JR横須賀線 逗子駅',
  15,
  50, 2, true, 30,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "ペット火葬": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 98000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 328000}]',
  ARRAY['民営火葬場', 'ペット火葬対応', '海近く', '逗子・葉山エリア'],
  '誠行社',
  3.9, 42
),

-- 3. 小さなお葬式 鶴見駅前ホール（横浜市鶴見区）
(
  '小さなお葬式 鶴見駅前ホール',
  'chiisana-ososhiki-tsurumi-ekimae',
  'private_hall',
  'JR鶴見駅西口から徒歩5分の好立地にある家族葬専用ホール。全国チェーン「小さなお葬式」の直営式場で、追加費用なしの明朗会計が特長。1日1組貸切で、温かくアットホームな葬儀が可能です。',
  '神奈川県横浜市鶴見区豊岡町29-6',
  'kanagawa', 'yokohama-tsurumi',
  35.5070, 139.6770,
  'JR京浜東北線 鶴見駅',
  5,
  30, 1, false, 5,
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 99000}, {"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 209000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 309000}]',
  ARRAY['駅近', '1日1組貸切', '明朗会計', '家族葬専門', '全国チェーン'],
  '小さなお葬式',
  4.3, 76
),

-- 4. 小さなお葬式 山手ホール（横浜市中区）
(
  '小さなお葬式 山手ホール',
  'chiisana-ososhiki-yamate',
  'private_hall',
  'JR山手駅から徒歩8分の閑静な住宅街にある家族葬ホール。1日1組貸切の温かな空間で、少人数でのお別れに最適。明朗会計で追加費用の心配がないため、安心して葬儀を任せられます。',
  '神奈川県横浜市中区上野町1-2',
  'kanagawa', 'yokohama-naka',
  35.4360, 139.6520,
  'JR根岸線 山手駅',
  ...
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 99000}, {"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 209000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 309000}]',
  ARRAY['駅近', '1日1組貸切', '明朗会計', '閑静な住宅街', '家族葬専門'],
  '小さなお葬式',
  4.2, 58
),

-- 5. 小さなお葬式 吉野町ホール（横浜市南区）
(
  '小さなお葬式 吉野町ホール',
  'chiisana-ososhiki-yoshinocho',
  'private_hall',
  '地下鉄ブルーライン吉野町駅から徒歩5分の民営葬儀ホール。横浜市南区エリアで家族葬をお考えの方に便利な立地。追加費用なしの定額プランで安心です。',
  '神奈川県横浜市南区睦町1-6-3',
  'kanagawa', 'yokohama-minami',
  35.4330, 139.6220,
  '横浜市営地下鉄ブルーライン 吉野町駅',
  ...
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 99000}, {"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 209000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 309000}]',
  ARRAY['駅近', '1日1組貸切', '明朗会計', '家族葬専門'],
  '小さなお葬式',
  4.1, 45
),

-- 6. 小さなお葬式 汐入アサヒホール（横浜市鶴見区）
(
  '小さなお葬式 汐入アサヒホール',
  'chiisana-ososhiki-shioiri-asahi',
  'private_hall',
  'JR鶴見駅からバス5分の立地にある民営葬儀ホール。家族葬から一般葬まで対応可能な複数ホールを備え、横浜市鶴見区周辺の方に広く利用されている式場です。',
  '神奈川県横浜市鶴見区汐入町2-36-3',
  'kanagawa', 'yokohama-tsurumi',
  35.5000, 139.6880,
  'JR京浜東北線 鶴見駅',
  10,
  60, 2, false, 15,
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true, "駐車場": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 99000}, {"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 209000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 309000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 509000}]',
  ARRAY['複数ホール', '一般葬対応', '明朗会計', '駐車場あり'],
  '小さなお葬式',
  4.0, 52
),

-- 7. 小さなお葬式 かわさき南部ホール（川崎市川崎区）
(
  '小さなお葬式 かわさき南部ホール',
  'chiisana-ososhiki-kawasaki-nanbu',
  'private_hall',
  'JR川崎駅からバスアクセスの民営葬儀ホール。かわさき南部斎苑に近い立地で、火葬場へのスムーズな移動が可能。家族葬に最適なコンパクトなホールです。',
  '神奈川県川崎市川崎区四谷上町27-16',
  'kanagawa', 'kawasaki-kawasaki',
  35.5280, 139.7310,
  'JR東海道線 川崎駅',
  ...
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true, "駐車場": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 99000}, {"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 209000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 309000}]',
  ARRAY['火葬場近く', '家族葬向け', '明朗会計', 'コンパクト'],
  '小さなお葬式',
  4.0, 38
),

-- 8. 小さなお葬式 小田栄ホール（川崎市川崎区）
(
  '小さなお葬式 小田栄ホール',
  'chiisana-ososhiki-odasakae',
  'private_hall',
  'JR小田栄駅から徒歩5分の民営葬儀ホール。川崎区南部エリアの方に便利な立地で、家族葬に特化したアットホームな空間を提供しています。',
  '神奈川県川崎市川崎区田島町12-9',
  'kanagawa', 'kawasaki-kawasaki',
  35.5210, 139.7180,
  'JR南武線 小田栄駅',
  ...
  30, 1, false, 5,
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 99000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 309000}]',
  ARRAY['駅近', '家族葬専門', '明朗会計', 'アットホーム'],
  '小さなお葬式',
  4.1, 32
),
...
(
  '小さなお葬式 幸ホール',
  'chiisana-ososhiki-saiwai',
  'private_hall',
  'JR川崎駅からバスアクセスの川崎市幸区にある民営葬儀ホール。多摩川近くの静かな環境で、家族葬に適した温かみのある空間を提供しています。',
  '神奈川県川崎市幸区戸手2-1-3',
  'kanagawa', 'kawasaki-saiwai',
  35.5430, 139.6890,
  'JR東海道線 川崎駅',
  15,
  30, 1, false, 8,
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true, "駐車場": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 99000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 309000}]',
  ARRAY['静かな環境', '家族葬専門', '明朗会計', '多摩川近く'],
  '小さなお葬式',
  4.0, 28
),

-- 10. 小さなお葬式 かわさき北部ホール（川崎市高津区）
(
  '小さなお葬式 かわさき北部ホール',
  'chiisana-ososhiki-kawasaki-hokubu',
  'private_hall',
  'JR南武線津田山駅から徒歩4分の好立地。かわさき北部斎苑のすぐ近くに位置し、火葬場への移動が非常に便利。家族葬から一般葬まで対応する複数のホールを備えています。',
  '神奈川県川崎市高津区下作延6-21-1',
  'kanagawa', 'kawasaki-takatsu',
  35.5880, 139.6150,
  'JR南武線 津田山駅',
  ...
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true, "駐車場": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 99000}, {"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 209000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 309000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 509000}]',
  ARRAY['駅近', '火葬場隣接', '複数ホール', '一般葬対応', '明朗会計'],
  '小さなお葬式',
  4.3, 65
),

-- 11. 小さなお葬式 鷺沼ホール（川崎市宮前区）
(
  '小さなお葬式 鷺沼ホール',
  'chiisana-ososhiki-saginuma',
  'private_hall',
  '東急田園都市線鷺沼駅近くの閑静な住宅街にある民営葬儀ホール。田園都市線沿線の方に便利な立地で、家族葬に特化した温かみのあるホールです。',
  '神奈川県川崎市宮前区東有馬4-1-5',
  'kanagawa', 'kawasaki-miyamae',
  35.5760, 139.5770,
  '東急田園都市線 鷺沼駅',
  ...
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true, "駐車場": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 99000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 309000}]',
  ARRAY['田園都市線沿線', '家族葬専門', '明朗会計', '閑静な住宅街'],
  '小さなお葬式',
  4.2, 40
),
...
(
  ...
  'hanasou-kawasaki',
  'private_hall',
  '川崎市中原区に本店を構える地域密着型の葬儀社。口コミランキングで上位を獲得する人気の葬儀社で、花祭壇に力を入れた華やかな演出が特長。故人ゆかりの地を巡る搬送サービス「故郷へ帰ろう」が好評です。',
  '神奈川県川崎市中原区上丸子山王町2-1377',
  'kanagawa', 'kawasaki-nakahara',
  35.5670, 139.6580,
  '東急東横線 新丸子駅',
  8,
  80, 2, false, 15,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true, "花祭壇": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 128000}, {"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 258000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 398000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 648000}]',
  ARRAY['花祭壇充実', '口コミ高評価', '地域密着', '故郷搬送サービス'],
  '花葬',
  4.6, 125
),

-- 13. 横浜葬儀社 はばたきホール（横浜市鶴見区）
(
  '横浜葬儀社 はばたきホール',
  'yokohama-sougisha-habataki',
  'private_hall',
  '横浜市鶴見区にある口コミランキング上位の葬儀社直営ホール。横浜市・川崎市を中心に対応し、公営斎場での葬儀を得意とする。経験豊富なスタッフによるきめ細やかなサポートが高い評価を受けています。',
  '神奈川県横浜市鶴見区鶴見1-3-12',
  'kanagawa', 'yokohama-tsurumi',
  35.5090, 139.6790,
  'JR京浜東北線 鶴見駅',
  ...
  100, 2, false, 20,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true, "宿泊設備": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 118000}, {"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 248000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 398000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 648000}]',
  ARRAY['口コミ高評価', '公営斎場葬儀', '宿泊可能', '経験豊富なスタッフ'],
  '横浜葬儀社（はばたきグループ）',
  4.5, 135
),

-- 14. 葬儀の板橋 ほうさい殿 横浜（横浜市港北区）
(
  '葬儀の板橋 ほうさい殿 横浜',
  'itabashi-housaiden-yokohama',
  'private_hall',
  '口コミで高い評価を得る「葬儀の板橋」が運営する横浜の式場。伝統的な葬儀から自由葬まで幅広く対応し、遺族一人ひとりの想いに寄り添った葬儀を実現。プロの司会者による進行が好評です。',
  '神奈川県横浜市港北区菊名7-1-15',
  'kanagawa', 'yokohama-kohoku',
  35.5060, 139.6350,
  '東急東横線 菊名駅',
  ...
  100, 2, false, 20,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true, "宿泊設備": true}',
  '[{"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 278000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 428000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 698000}]',
  ARRAY['口コミ高評価', 'プロ司会者', '自由葬対応', '駅近'],
  '葬儀の板橋',
  4.4, 98
),
...
(
  '公益社 横浜ホール',
  'koekisha-yokohama-hall',
  'private_hall',
  '大手葬儀社「公益社」が運営する横浜の式場。140年以上の歴史を持つ老舗で、社葬や大規模葬儀にも対応。品格のある葬儀を求める方に選ばれています。',
  '神奈川県横浜市西区北幸2-9-10',
  'kanagawa', 'yokohama-nishi',
  35.4650, 139.6180,
  'JR東海道線 横浜駅',
  8,
  200, 3, false, 30,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true, "宿泊設備": true, "VIPルーム": true}',
  '[{"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 498000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 798000}, {"type": "shaso", "label": "社葬プラン", "priceFrom": 1500000}]',
  ARRAY['大手葬儀社', '140年の歴史', '社葬対応', '品格のある葬儀', 'VIPルーム'],
  '公益社',
  4.3, 72
),

-- 16. くらしの友 横浜ホール（横浜市中区）
(
  'くらしの友 横浜ホール',
  'kurashinotomo-yokohama',
  'private_hall',
  '大手互助会系葬儀社「くらしの友」の横浜拠点。関東を中心に展開し、互助会会員には割引料金が適用。家族葬から大規模葬儀まで幅広く対応し、藤沢・鎌倉・茅ヶ崎エリアもカバーしています。',
  '神奈川県横浜市中区山下町22-1',
  'kanagawa', 'yokohama-naka',
  35.4430, 139.6530,
  'みなとみらい線 元町・中華街駅',
  ...
  150, 3, false, 20,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true, "宿泊設備": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 148000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 398000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 698000}]',
  ARRAY['大手互助会系', '互助会割引あり', '駅近', '広範囲対応'],
  'くらしの友',
  4.1, 65
),

-- 17. メモリアルアートの大野屋 横浜ホール（横浜市港北区）
(
  'メモリアルアートの大野屋 横浜ホール',
  'ohnoya-yokohama-hall',
  'private_hall',
  '墓石・仏壇の大手「大野屋」が運営する葬儀式場。葬儀から仏壇・墓石・法要まで、総合的な終活サポートが特長。ホテルライクな上質な空間で、心に残るお別れの場を提供しています。',
  '神奈川県横浜市港北区新横浜2-5-10',
  'kanagawa', 'yokohama-kohoku',
  35.5100, 139.6180,
  'JR横浜線 新横浜駅',
  ...
  80, 2, false, 15,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 138000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 398000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 648000}]',
  ARRAY['総合終活サポート', '仏壇・墓石対応', 'ホテルライク', '新横浜駅近く'],
  'メモリアルアートの大野屋',
  4.2, 55
),

-- 18. ベルコ 横浜旭シティホール（横浜市旭区）
(
  'ベルコ 横浜旭シティホール',
  'bellco-yokohama-asahi-city-hall',
  'private_hall',
  '大手互助会系葬儀社「ベルコ」の横浜市旭区拠点。全国展開する安心のブランドで、互助会会員には各種特典あり。バリアフリー完備の近代的な施設で、家族葬から一般葬まで対応しています。',
  '神奈川県横浜市旭区二俣川1-45-76',
  'kanagawa', 'yokohama-asahi',
  35.4620, 139.5270,
  '相鉄本線 二俣川駅',
  8,
  100, 2, false, 30,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true, "宿泊設備": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 128000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 398000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 648000}]',
  ARRAY['大手互助会', '全国チェーン', '互助会特典あり', '近代的施設', 'バリアフリー'],
  'ベルコ',
  4.0, 48
),

-- 19. ベルコ 横浜青葉シティホール（横浜市青葉区）
(
  'ベルコ 横浜青葉シティホール',
  'bellco-yokohama-aoba-city-hall',
  'private_hall',
  '東急田園都市線沿線にあるベルコの横浜市青葉区拠点。閑静な住宅街に位置し、上質な空間で心安らぐ葬儀を提供。家族葬プランが特に人気で、少人数での温かなお別れに適しています。',
  '神奈川県横浜市青葉区青葉台1-6-13',
  ...
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 128000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 398000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 648000}]',
  ARRAY['田園都市線沿線', '駅近', '閑静な住宅街', '家族葬人気'],
  'ベルコ',
  4.1, 42
),

-- 20. さがみ典礼 横浜保土ケ谷ホール（横浜市保土ケ谷区）
(
  'さがみ典礼 横浜保土ケ谷ホール',
  'sagami-tenrei-hodogaya-hall',
  'private_hall',
  '横浜市保土ケ谷区にあるさがみ典礼運営の葬儀式場。地域に密着した丁寧なサービスで、家族葬から一般葬まで幅広く対応。保土ケ谷駅からのアクセスも良好な立地です。',
  '神奈川県横浜市保土ケ谷区岩井町1-6',
  ...
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true}',
  '[{"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 248000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 398000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 648000}]',
  ARRAY['大手葬儀社', '地域密着', '駅徒歩圏内', '2ホール'],
  'さがみ典礼',
  4.1, 55
),

-- 21. さがみ典礼 横浜磯子ホール（横浜市磯子区）
(
  'さがみ典礼 横浜磯子ホール',
  'sagami-tenrei-isogo-hall',
  'private_hall',
  '横浜市磯子区にあるさがみ典礼の式場。根岸線沿線の方に便利な立地で、磯子エリアの葬儀ニーズに対応。落ち着いた雰囲気の中で、大切な方とのお別れの時間を過ごせます。',
  '神奈川県横浜市磯子区磯子3-6-20',
  ...
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true}',
  '[{"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 248000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 398000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 648000}]',
  ARRAY['大手葬儀社', '根岸線沿線', '駅徒歩圏内', '落ち着いた雰囲気'],
  'さがみ典礼',
  4.0, 45
),

-- 22. さがみ典礼 横浜都筑ホール（横浜市都筑区）
(
  'さがみ典礼 横浜都筑ホール',
  'sagami-tenrei-tsuzuki-hall',
  'private_hall',
  '横浜市都筑区にある港北ニュータウンエリアの葬儀式場。さがみ典礼が運営し、若いファミリー層の多いエリアで家族葬を中心に丁寧な葬儀サービスを提供しています。',
  '神奈川県横浜市都筑区中川1-4-1',
  ...
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true}',
  '[{"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 248000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 398000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 648000}]',
  ARRAY['大手葬儀社', '港北ニュータウン', '家族葬中心', '駐車場完備'],
  'さがみ典礼',
  4.1, 50
),

-- 23. さがみ典礼 川崎麻生ホール（川崎市麻生区）
(
  'さがみ典礼 川崎麻生ホール',
  'sagami-tenrei-kawasaki-asao-hall',
  'private_hall',
  '川崎市麻生区にあるさがみ典礼運営の葬儀式場。新百合ヶ丘駅に近い好立地で、小田急多摩線・小田急線沿線の方に広く利用されています。緑豊かなエリアで落ち着いた葬儀が可能。',
  '神奈川県川崎市麻生区万福寺1-12-1',
  'kanagawa', 'kawasaki-asao',
  35.6030, 139.5070,
  '小田急小田原線 新百合ヶ丘駅',
  8,
  100, 2, false, 25,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true, "宿泊設備": true}',
  '[{"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 258000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 418000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 698000}]',
  ARRAY['大手葬儀社', '新百合ヶ丘駅近く', '宿泊可能', '緑豊かなエリア'],
  'さがみ典礼',
  4.2, 58
),

-- 24. さがみ典礼 川崎多摩ホール（川崎市多摩区）
(
  'さがみ典礼 川崎多摩ホール',
  'sagami-tenrei-kawasaki-tama-hall',
  'private_hall',
  '川崎市多摩区にあるさがみ典礼の式場。登戸駅・向ヶ丘遊園駅近くの立地で、多摩区・稲城市エリアの方に便利。多摩川沿いの穏やかな環境で、心安らぐお別れの場を提供しています。',
  '神奈川県川崎市多摩区登戸2130-2',
  ...
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true}',
  '[{"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 248000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 398000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 648000}]',
  ARRAY['大手葬儀社', '登戸駅近く', '多摩川沿い', '2ホール'],
  'さがみ典礼',
  4.1, 42
),

-- 25. 家族葬の花水木 横浜戸塚（横浜市戸塚区）
(
  '家族葬の花水木 横浜戸塚',
  'hanamizuki-yokohama-totsuka',
  'private_hall',
  '横浜市戸塚区にある家族葬専門のホール。戸塚斎場に近い立地で、火葬場への移動が便利。自宅のようなリビング感覚の空間で、最大20名程度の小規模な葬儀に特化しています。',
  '神奈川県横浜市戸塚区戸塚町4911-1',
  'kanagawa', 'yokohama-totsuka',
  35.3990, 139.5330,
  'JR東海道線 戸塚駅',
  ...
  20, 1, false, 8,
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 95000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 288000}]',
  ARRAY['家族葬専門', '火葬場近く', 'リビング感覚', '少人数特化'],
  '花水木',
  4.4, 65
),

-- 26. よりそうのお葬式 横浜栄ホール（横浜市栄区）
(
  'よりそうのお葬式 横浜栄ホール',
  'yorisou-yokohama-sakae',
  'private_hall',
  '横浜市栄区にある「よりそうのお葬式」提携の葬儀ホール。NHKなどメディアにも多数紹介された大手葬儀ブランドで、全額返金保証付きの明朗会計。本郷台駅からアクセス可能です。',
  '神奈川県横浜市栄区桂町80-1',
  'kanagawa', 'yokohama-sakae',
  35.3710, 139.5600,
  'JR根岸線 本郷台駅',
  10,
  60, 2, false, 15,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "安置室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 89000}, {"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 189000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 289000}]',
  ARRAY['全額返金保証', '明朗会計', 'メディア紹介多数', '安心のブランド'],
  'よりそうのお葬式',
  4.2, 50
),

-- 27. セレモニーホール横浜泉（横浜市泉区）
(
  'セレモニーホール横浜泉',
  'ceremony-hall-yokohama-izumi',
  'private_hall',
  '横浜市泉区の閑静な住宅街にある民営葬儀式場。いずみ野駅からアクセス可能で、泉区・瀬谷区・大和市エリアの方に利用されています。花祭壇の美しさに定評があり、温かな雰囲気の葬儀が可能です。',
  '神奈川県横浜市泉区和泉町3015-8',
  'kanagawa', 'yokohama-izumi',
  35.4120, 139.4870,
  '相鉄いずみ野線 いずみ野駅',
  ...
  80, 2, false, 25,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true, "花祭壇": true}',
  '[{"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 228000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 358000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 578000}]',
  ARRAY['花祭壇充実', '閑静な環境', '広範囲対応', '駐車場完備'],
  'セレモニーホール横浜泉',
  4.2, 48
),
...
(
  ...
  'famille-kamakura',
  'private_hall',
  '古都鎌倉にある家族葬専門のファミーユ店舗。全国展開するファミーユブランドの鎌倉店として、鎌倉の風情を感じる空間で温かなお別れの時間を提供。リーズナブルな価格設定が魅力です。',
  '神奈川県鎌倉市大船1-25-30',
  'kanagawa', 'kamakura',
  35.3540, 139.5330,
  'JR東海道線 大船駅',
  ...
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 95000}, {"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 198000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 328000}]',
  ARRAY['家族葬専門', '全国チェーン', '大船駅近く', 'リーズナブル'],
  'ファミーユ',
  4.3, 72
),
...
(
  'セレモニーホール藤沢',
  'ceremony-hall-fujisawa',
  'private_hall',
  '藤沢市の中心部にある民営葬儀式場。藤沢駅からのアクセスが良好で、湘南エリアの方に広く利用されています。花祭壇やオリジナル演出など、こだわりの葬儀プランが人気です。',
  '神奈川県藤沢市藤沢1015-14',
  'kanagawa', 'fujisawa',
  35.3370, 139.4870,
  'JR東海道線 藤沢駅',
  ...
  100, 2, false, 25,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true}',
  '[{"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 238000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 378000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 598000}]',
  ARRAY['湘南エリア', '駅徒歩圏内', '花祭壇充実', 'オリジナル演出'],
  'セレモニーホール藤沢',
  4.2, 55
),
...
(
  ...
  'famille-hiratsuka',
  'private_hall',
  '平塚市にある家族葬専門のファミーユ店舗。平塚駅からのアクセスが可能で、平塚・大磯・二宮エリアの方に利用されています。追加費用なしの明朗会計で、安心して葬儀を任せられます。',
  '神奈川県平塚市宝町10-4',
  'kanagawa', 'hiratsuka',
  35.3290, 139.3480,
  'JR東海道線 平塚駅',
...
(
  ...
  'samukawa-saijo',
  'public_facility',
  '寒川町にある公営の式場。茅ヶ崎市斎場の火葬場を利用する形で、式場のみの施設。寒川神社に近い静かな環境に位置し、寒川町民の方は低料金で利用可能です。',
  '神奈川県高座郡寒川町宮山3840',
  'kanagawa', 'samukawa',
  35.3710, 139.3830,
  'JR相模線 宮山駅',
  ...
  60, 1, false, 20,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true}',
  '[{"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 258000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 458000}]',
  ARRAY['公営施設', '町民優先', '寒川神社近く', '静かな環境'],
  '寒川町',
  3.8, 15
),
...
(
  '葉山町福祉文化会館 式場',
  'hayama-fukushi-bunka-kaikan',
  'public_facility',
  '葉山町が運営する公営の式場施設。葉山町の緑豊かな環境に位置し、町民は優先的かつ低料金で利用可能。小規模な家族葬に適した式場を備えています。',
  '神奈川県三浦郡葉山町堀内2220',
  'kanagawa', 'hayama',
  35.2730, 139.5840,
  'JR横須賀線 逗子駅',
  15,
  50, 1, false, 15,
  '{"バリアフリー": true, "駐車場": true, "待合室": true}',
  '[{"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 248000}]',
  ARRAY['公営施設', '町民優先', '緑豊かな環境', '少人数向け'],
  '葉山町',
  3.7, 10
),
...
(
  '南足柄市斎場',
  'minamiashigara-saijo',
  'public_crematorium',
  '南足柄市が運営する公営斎場。金太郎伝説で知られる足柄の自然豊かな環境に位置。火葬炉3基と式場を備え、南足柄市民は火葬料が減額されます。開成町・山北町・松田町の住民も利用可能です。',
  '神奈川県南足柄市塚原710',
  ...
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 68000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 278000}]',
  ARRAY['公営斎場', '火葬場併設', '市民料金あり', '自然豊かな環境', '広域利用可能'],
  '南足柄市',
  3.8, 12
),
...
(
  ...
  'hakone-saijo',
  'public_crematorium',
  '箱根町が運営する公営の火葬場。箱根の山々に囲まれた静寂な環境で故人を見送れます。火葬炉2基と待合室を備えたコンパクトな施設。箱根町民は火葬料が減額されます。',
  '神奈川県足柄下郡箱根町宮城野121',
  'kanagawa', 'hakone',
  35.2470, 139.0740,
  '箱根登山鉄道 強羅駅',
...
(
  ...
  'yugawara-saijo',
  'public_crematorium',
  '湯河原町にある公営の火葬場。温泉地として知られる湯河原の穏やかな環境に位置。真鶴聖苑と共同利用する形で、湯河原町民は火葬料が免除されます。',
  '神奈川県足柄下郡湯河原町宮上42',
  'kanagawa', 'yugawara',
  35.1520, 139.1050,
  'JR東海道線 湯河原駅',
...
(
  'アイセ・メモリアル 大和',
  'aise-memorial-yamato',
  'private_hall',
  '大和市にある民営の葬儀専門ホール。大和斎場に近い立地で、火葬場へのスムーズな移動が可能。家族葬を中心に、地域密着型のきめ細やかなサービスを提供しています。',
  '神奈川県大和市西鶴間1-12-5',
  'kanagawa', 'yamato',
  35.4780, 139.4620,
  '小田急江ノ島線 鶴間駅',
  ...
  80, 2, false, 20,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 118000}, {"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 248000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 378000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 598000}]',
  ARRAY['大和斎場近く', '地域密着', '家族葬中心', '2ホール'],
  'アイセ・メモリアル',
  4.1, 52
),

-- 37. 家族葬のファミーユ 相模原（相模原市中央区）
(
  '家族葬のファミーユ 相模原',
  'famille-sagamihara',
  'private_hall',
  '相模原市中央区にある家族葬専門のファミーユ店舗。相模原駅からアクセス可能で、相模原市内外の方に利用されています。1日1組貸切の温かな空間で、少人数のお別れに最適です。',
  ...
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 95000}, {"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 198000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 328000}]',
  ARRAY['家族葬専門', '1日1組貸切', '全国チェーン', 'リーズナブル'],
  'ファミーユ',
  4.2, 48
),
...
(
  ...
  'private_hall',
  '厚木市中心部にある民営の葬儀式場。本厚木駅からのアクセスが良好で、厚木市内外の方に幅広く利用されています。大ホールと小ホールの2室を備え、さまざまな規模の葬儀に対応。',
  '神奈川県厚木市中町2-12-15',
  'kanagawa', 'atsugi',
  35.4430, 139.3650,
  '小田急小田原線 本厚木駅',
  ...
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true, "僧侶控室": true, "宿泊設備": true}',
  '[{"type": "ichinichisou", "label": "一日葬プラン", "priceFrom": 228000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 358000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 578000}]',
  ARRAY['駅近', '2ホール', '宿泊可能', '幅広い規模対応'],
  'セレモニーホール厚木',
  4.1, 45
),

-- 39. 横須賀家族葬ホール おもいで（横須賀市）
(
  '横須賀家族葬ホール おもいで',
  'yokosuka-kazokusou-omoide',
  'private_hall',
  '横須賀市にある家族葬専門の式場。三浦半島エリアで家族葬をお考えの方に最適。1日1組貸切で、故人との大切な時間をゆっくり過ごせるアットホームな空間です。',
  '神奈川県横須賀市大滝町2-6',
  'kanagawa', 'yokosuka',
  35.2810, 139.6700,
  '京急本線 横須賀中央駅',
  ...
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 98000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 298000}]',
  ARRAY['家族葬専門', '1日1組貸切', '駅近', '三浦半島エリア'],
  'おもいで',
  4.3, 55
),

-- 40. 大磯プリンスホテル メモリアルホール（大磯町）
(
  '大磯メモリアルホール',
  'oiso-memorial-hall',
  'private_hall',
  '大磯町にある民営の葬儀式場。大磯駅からのアクセスが可能で、大磯町・二宮町エリアの方に利用されています。湘南の海に近い穏やかな環境で、温かなお別れの場を提供。',
  '神奈川県中郡大磯町大磯1000-1',
  'kanagawa', 'oiso',
  35.3070, 139.3170,
  'JR東海道線 大磯駅',
  ...
  60, 1, false, 20,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true}',
  '[{"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 328000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 548000}]',
  ARRAY['湘南エリア', '海近く', '穏やかな環境', '大磯・二宮対応'],
  '大磯メモリアル',
  4.0, 22
),
...
(
  'セレモニーホール二宮',
  'ceremony-hall-ninomiya',
  'private_hall',
  '中郡二宮町にある地域密着型の民営葬儀式場。二宮駅から近い立地で、地元の方に親しまれている施設です。家族葬から一般葬まで対応可能で、丁寧なスタッフの対応が好評です。',
  '神奈川県中郡二宮町二宮880-5',
  'kanagawa', 'ninomiya',
  35.3000, 139.2560,
  'JR東海道線 二宮駅',
  ...
  60, 1, false, 15,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true}',
  '[{"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 298000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 498000}]',
  ARRAY['地域密着', '駅近', '丁寧な対応', '家族葬対応'],
  'セレモニーホール二宮',
  3.9, 18
),
...
(
  '開成町メモリアルホール',
  'kaisei-memorial-hall',
  'private_hall',
  '足柄上郡開成町にある葬儀式場。あじさいの里として知られる開成町の静かな環境に立地。小田急線新松田駅からアクセス可能で、足柄上エリアの方に利用されています。',
  '神奈川県足柄上郡開成町延沢850',
  'kanagawa', 'kaisei',
  35.3340, 139.1420,
  '小田急小田原線 新松田駅',
  ...
  50, 1, false, 15,
  '{"霊安室": true, "バリアフリー": true, "駐車場": true, "待合室": true}',
  '[{"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 278000}, {"type": "ippansou", "label": "一般葬プラン", "priceFrom": 478000}]',
  ARRAY['地域密着', '静かな環境', '足柄上エリア', '駐車場完備'],
  '開成メモリアル',
  3.8, 12
),

-- 43. 横浜緑区家族葬ホール さくら（横浜市緑区）
(
  '横浜緑区家族葬ホール さくら',
  'yokohama-midori-kazokusou-sakura',
  'private_hall',
  '横浜市緑区にある家族葬専門のホール。北部斎場に近い立地で、火葬場へのスムーズな移動が可能。桜をモチーフにした温かみのあるインテリアで、心安らぐお別れの空間を提供しています。',
  '神奈川県横浜市緑区長津田5-1-30',
  'kanagawa', 'yokohama-midori',
  35.5230, 139.4950,
  'JR横浜線 長津田駅',
  ...
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true, "駐車場": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 98000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 298000}]',
  ARRAY['家族葬専門', '北部斎場近く', '桜モチーフ', '温かみのある空間'],
  'さくら葬祭',
  4.3, 55
),

-- 44. 小さなお葬式 鶴見駒岡ホール（横浜市鶴見区）
(
  '小さなお葬式 鶴見駒岡ホール',
  'chiisana-ososhiki-tsurumi-komaoka',
  'private_hall',
  '横浜市鶴見区駒岡にある「小さなお葬式」の直営式場。東急東横線綱島駅からバスアクセス。住宅街の中にある落ち着いた式場で、家族葬に最適です。',
  '神奈川県横浜市鶴見区駒岡1-28-8',
  'kanagawa', 'yokohama-tsurumi',
  35.5180, 139.6660,
  '東急東横線 綱島駅',
  ...
  '{"霊安室": true, "バリアフリー": true, "安置室": true, "待合室": true}',
  '[{"type": "kasoshiki", "label": "火葬式プラン", "priceFrom": 99000}, {"type": "kazokusou", "label": "家族葬プラン", "priceFrom": 309000}]',
  ARRAY['家族葬専門', '明朗会計', '住宅街', '全国チェーン'],
  '小さなお葬式',
  4.0, 35
),

-- 45. 小さなお葬式 大島ホール（川崎市川崎区）
(
  '小さなお葬式 大島ホール',
  'chiisana-ososhiki-oshima',
  'private_hall',
  'JR川崎駅からバスアクセスの川崎市川崎区大島にある民営葬儀ホール。かわさき南部斎苑への移動が便利な立地で、家族葬を中心としたリーズナブルなプランを提供しています。',
  '神奈川県川崎市川崎区大島5-11-15',
  'kanagawa', 'kawasaki-kawasaki',
  35.5250, 139.7200,
  'JR東海道線 川崎駅',
