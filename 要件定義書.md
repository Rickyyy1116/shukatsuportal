...
| OpenNextアダプター設定 | 未着手 |
| Cloudflare Workersデプロイ | 未着手 |
| portal.shukatsu-ansin.com DNS設定 | 未着手 |
...
| 5 | OpenNextアダプター設定 | `@opennextjs/cloudflare` の導入・設定 |
| 6 | Cloudflare Workersデプロイ | 初回デプロイ + DNS設定 |
